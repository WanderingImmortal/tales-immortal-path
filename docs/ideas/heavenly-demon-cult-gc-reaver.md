...
| Field | Value |
|-------|-------|
| **Status** | `designed` (v1 — lifestyle slice) |
...
**Player sentence:** *You are no longer shaped. You are **deployed**.*
...
**Cult posture:** *"The maw does not throw away meat it already swallowed."* — investment calculus begins here; sacrifice is **strategic**, not petty hall murder.
...
| **Tithe** | Gorge storehouse — **GC-scaled** quota | Same 3-month cadence — **higher amount**, same thin-harvest cruelty |
...
|------|-------------------|------|
| **Circulation** | **Feeding Circulation** (ch.1) — upgrade from Stained Circulation | GC gather/refine/stabilize; apex cult quality, **no stability malus** |
| **Intent syllabus** | First Taking rite, siphon doctrine, chain-kill groundwork | Unlocks **First Taking** comprehension beat |
| **Predator arts** | Mission techniques — buff peel, marked prey tracking | **Parked** until damage rework |
| **Feast groundwork** | Gorge Feast Rite (monthly ceremony) | Builds toward **Feast** (3rd intent realm) — late GC / NS |
| **Combat** | **Heaven-Defying Swallow** (sketch) — heavy buff peel | **Parked** |

**Not in Layer 3:** law fragments, meridian canon, Inner Maw (Layer 4).

### Manual presentation

```
封面  Cover — closed maw sigil (teeth inward)
第一章  Ch.1 — Feeding Circulation
...
| Requirement | Why |
|-------------|-----|
| **Golden Core** | Accepted heavens — prodigy bypass exists at FE |
| **10 intent uses** at Stirring | Cultivator kills / lethal spars |
| **Layer 3 comprehended** | First Taking rite unlocked |
| **First Taking beat** | Win duel with **mid-fight siphon** + finish bracket prey |
...
|---------------|-------------------|
| Prey sense, post-kill conversion bump | **Qi Siphon** on basics — sustain in long fights |
| +15% person-yield on finish | **+25%** person-yield on finish |
| Intent uses accrue | **Predator's Mark** expand art available |
| No mid-fight pull | Dyadic drain — duel identity |
...
**Failure mode:** GC without **Taking** — decades as **Initiate-equivalent** predator without scroll; cult uses you, won't promote you.
...
| Job | Posting | Cadence | Scale | Merit | Intent credit |
|-----|---------|---------|-------|-------|---------------|
| **Marked hunt** | Main | Weekly rotation | GC-bracket cultivator prey | High | Full — primary grind |
...
| **Suicide bait** | Both | Rare | Draw sect hunters so elder can strike | High if you live | — |
| **Feast Rite** | Main | Monthly | Gorge ceremony + kill proof | Medium | Feast groundwork |

**Reporting:** all marked kills **logged by elder**; branch must declare at envoy check-in or heat is **personal**, not cell-backed.

**Initiate contrast:** local beast/bandit triangle; QC–early FE prey; no persistent rival investment.
...
**Blood-fiend seal (FE peak):** +25% conversion stacks with Taking — still not a hidden speed stat; volume + bracket choice drives evil pace.
...
| **Player loss** | Drop stipend tier; train, hunt, rematch — same comeback rules apply to you |
| **Sacrifice** | Cult **will** spend you on suicide missions, bait, siege — **for gain**. Not bunk beef |

**Spar culture:** *"The maw does not throw away meat it already swallowed."*

### Rival archetypes (working — 2–3 per cohort)

| Archetype | Fiction | Spar hook |
|-----------|---------|-----------|
| **Ledger climber** | Merit-obsessed; fights clean, logs everything | Ranked quarterly placement battles |
| **Gray hunter** | Off-book prey; bounty heat you inherit if they lose | Death match only with elder |
| **Gorge favorite** | Main-cult pedigree; talks down to branch transfers | Yield spars — psychological pressure |
...
|--------|---------|--------------|
| **A — Marked PvE hunt** | Track and kill assigned GC rogue | High — default |
| **B — Ranked rival spar** | Beat persistent rival to yield in trial month | High — equal to A |
| **C — Relic proof** | Retrieve tempered shard from ruin | Medium — alternate path |

**Owner lean:** A or B — player choice when trial month opens; both require **Taking** online.
...
| Marked hunts / kills logged | High |
| Ranked spar outcomes | **Very high** |
| Relic retrieval | High |
| Trial completion | Promotion gate |
| Envoy / elder praise | Low — rare |

**Strength bump:** last spar win, realm substage, fight record can move rank when merit is within ~10% — hands-off cult still **notices** teeth.

**Gates from ledger:** inner-store access (main), gorge transfer pitch (branch), death-match sanction, Inner Demon sponsor consideration.
...
5. Tithe accrual — GC quota ticks toward 3-month due date
6. Feast Rite  — monthly ceremony (if kill proof held)
```

### Monthly loop (branch)

```
1. Cultivate   — safehouse; hide arts when bounty hot
2. Bounty board — tier 2 picks; cross-cell jobs
3. Hunt        — marked prey; declare at envoy check-in
4. Tithe accrual — GC amount hurts
5. Rival       — same cohort names may be branch or main — travel for spars
6. Transfer pitch — quarterly review if merit top 20%
```
...
| **Merit placement** | Cohort rank published — rival grudges update |
| **Trial window** | Open for unpromoted GC assets (edge case) |
...
| **Identity** | Shaped asset | **Deployed inventory** |
| **Spar culture** | Lethal default | **Yield** default; death match sanctioned |
| **Rivals** | Replaceable bunkmates | **Persistent** 2–3 names |
| **Pills** | 1/4 merit pool scramble | **Ranked stipend** |
...
| Requirement | Detail |
|-------------|--------|
| **Realm** | **Core Formation** (or NS band — TBD with owner GC→Core pass) |
| **Intent** | **Feast** (3rd realm) — late GC groundwork; full gate at Core+ |
| **Merit** | Relic custody trial; teach initiate rotation |
...
| Risk | Source |
|------|--------|
| **Bounty tier 2** | Named on orthodox charters |
| **Sect hunter parties** | Visible predator — not rumor anymore |
| **Corruption** | Off-book hunts, massacre feeding |
| **Cult sacrifice** | Suicide bait, siege fodder — **strategic**, not random |
| **Persistent rival** | Stipend theft, death-match grudge |
| **Exposure** | GC arts on main street — Rule 3; worse heat than FE |
| **Inventory mindset** | Gorge **will** trade your life for relic / intel |
...
| **Gorge transfer** (branch) | Merit gate | First blind route — HQ at last |
| **Feast groundwork** | Late GC | Window flickers — *"The fallen leave residue."* |

---

## Parked / out of scope (v1 docs)
