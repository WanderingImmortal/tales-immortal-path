# Cosmology — ancients taxonomy (not epoch copy-paste)
...
Related: [`void-temple-sect.md`](void-temple-sect.md) (prisoner), [`post-immortal-cosmology.md`](post-immortal-cosmology.md) (Seal / siphon), [`chaos-cultivation-path.md`](chaos-cultivation-path.md) (grotto mentors parked), [`dustbone-dynasties-entropy-lore.md`](dustbone-dynasties-entropy-lore.md) (local Pinwright).

---

## What we are **not** building (guardrail)

| Trope to avoid | Why |
|----------------|-----|
| **Named Desolates / numbered epochs** that reset the world on a schedule | Reads as **copy-paste** cycle fiction; crowds the mandate timeline |
| **Every hidden boss = last era’s monarch** | Collapses Tian “first Half-Step” drama and makes jianghu a retirement home for emperors |
| **Grotto = time capsule of civilization N−1** | Same problem — players start predicting “epoch 8 survivor” |

**What we keep:** pressure of **old things in the walls**, **mentors who shouldn’t exist**, **one unkillable mistake** in Void Prison — without a **cycle counter** in setting bible.

---

## One heaven, many **shelves** (taxonomy)

Same **continuity** from Chaos seal → Dao Wars → mandate. No official setting doc for “the ninth destruction.” Instead, four **categories** (expand later; don’t merge):

```text
                    [ Current heaven's rulebook ]
                              |
        ┌─────────────┬───────┴───────┬─────────────┐
        |             |               |             |
   GROTTO MASTER   SEALED ANCIENT   UNCLASSIFIED   MORTAL LEGEND
   (this era,      (this era,       (pre-taxonomy   (Pinwright,
    chose hide)      oath/site)      / outside)      Dustbone, etc.)
        |             |               |             |
   Hidden grottos   Forbidden       Void Prisoner   Chronicle
   time-dilation    grounds bosses  ONLY flagship   flavor
```

| Category | **Heaven** | **Typical origin** | **Player fantasy** | **Examples** |
|----------|------------|--------------------|--------------------|--------------|
...
## Pre-heaven **without** epoch survivors

**Pre-heaven** in setting text means **before this heaven’s categories apply to you** — not “human society from the previous universal cycle.”
...
### How severance happens (multiple doors, same outcome)
...
### Why the **jianghu forgets** (mechanism, not magic amnesia)

Forgotten = **institutional + karmic fade**, not mass mind wipe.
...
| **Spirit sense** | Reads **hole** or **static**, not “Nascent Soul peak” — confuses scouts |

**Grotto array** adds **time skew** — a master who sealed for **200 inside / 20 outside** misses **every** war and charter edit; textbooks **never** had room for them.

### What grotto masters **can** still do

- Teach **forbidden** or **pre-Chaos** insights from **inside** the pocket.
- **Bargain** at grotto mouth (player finds forbidden ground).
- **Cannot** casually re-enter charter politics without **re-registration** (tribulation, fate threads, heaven **notices** again) — good plot cost.

### Relation to Void prisoner
...
## Sealed ancients (category B) — rework next

**Parked.** Current explore / forbidden stubs mix **oath-bound**, **site-locked**, and **boss** without severance vs seal distinction. Next pass: split **seal** (heaven still knows you exist) vs **severance** (heaven stopped counting). See open questions.

---

## Grotto masters (align existing stubs)

[`chaos-cultivation-path.md`](chaos-cultivation-path.md) and [`post-immortal-cosmology.md`](post-immortal-cosmology.md) mention **Grotto Masters** as Chaos cautionary tales — **subset** of category **A**, not the whole category:

| Grotto master flavor | Role |
|----------------------|------|
| **Hermit savant** | Teaches odd art; **severance** by oath or long isolation |
| **Failed / partial Chaos walker** | **Heaven-path severance** — cautionary; Devourer / Lost Pilgrim *(endgame parked)* |
| **Dao Wars hideout** | Sealed during wars; **array + time** caused **de facto** excision — still **this-era** bones and grudges |

**Design rule:** If they use **market manuals**, **FE seals**, or **charter gossip**, they’re **category A or B**, not **C**.

---

## Inspiration ledger (honest)

| Borrowed **energy** | **Our** divergent hook |
|---------------------|-------------------------|
| Hidden teacher in pocket realm | **Grotto master** — **this heaven**, time skew, not epoch number |
| Something unkillable in a prison | **One** unclassified prisoner — **ontology**, not cycle |
| World feels older than history | **Seal + mandate** patches, Dustbone entropy — **no** countdown to next Desolate |
| Ascended ones drain the world | **Siphon / World Fortune** — **impersonal** array, not survivor kings |
...
- [ ] First **named** grotto master for MVP — Watcher vs Dao Wars hideout?
- [ ] Chronicle: teach taxonomy in Void archive vs never explicit?
