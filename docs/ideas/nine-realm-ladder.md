...
- Body idx 8 capstone (generic): **Saintly Flesh** realm (圣体境); person title **Flesh Saint** (肉身圣人) — **圣** lane, not 仙 immortal — see [`body-path-sect.md`](body-path-sect.md). Buddhist **Golden Body Arhat** (金身罗汉) is **Vajra Ridge only**.
