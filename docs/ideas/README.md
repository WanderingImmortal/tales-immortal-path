...
| [Combat — damage depth (systems)](combat-damage-depth.md) | `building` (A+B PR #116) | Zonal pass; Phase C intent | [PR #116](https://github.com/WanderingImmortal/tales-immortal-path/pull/116) |
