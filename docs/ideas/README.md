...
|------|--------|------------|-------|
| [Formations & arrays](formations-and-arrays.md) | `building` (F2a on PR) | F2b exams; Trace optional | [#61](https://github.com/WanderingImmortal/tales-immortal-path/pull/61) |
