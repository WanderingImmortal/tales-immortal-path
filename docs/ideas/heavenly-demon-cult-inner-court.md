# Heavenly Demon Cult — inner court (succession, seven, pit)

| Field | Value |
|-------|-------|
| **Status** | `designed` (brainstorm lock 2026-08-29) |
...
## Three locks (succession model)

| Lock | Who believes | Prize | Truth |
|------|--------------|-------|-------|
| **Outer myth** | Juniors, propaganda | "Next Heavenly Demon rises from the pit" | **Ruse** — motivates grunts ([`blood-sealing-gorge.md`](blood-sealing-gorge.md)) |
| **Middle admin** | Inner court, seven disciples | **Patriarch** — Mo Xuan's seals, branches, pulpit schedule | **Real** human job — stable, valuable, unglamorous |
| **Inner research** | Pit attendants, founder, Mo Xuan (partial) | **Specimens** — rule-breakers in a box | **Not** succession — founder R&D |

```text
MYTH  →  Heavenly Demon (clone / sermon face)
ADMIN →  Mo Xuan + seven (state arm)
TRUTH →  Founder in pit + two specimens
```
...
## Mo Xuan's seven (public disciples)

**Status:** `designed` (archetype lock 2026-08-30 — names TBD).

| Field | Lock |
|-------|------|
| **Count** | **7** public disciples — all **Patriarch candidates** (魔印嗣) |
| **Succession** | Chair + full seals transfer **only when Mo Xuan dies** — no early coronation |
| **Competition (now)** | **Resources, sacred access, founder proximity** — not the throne |
| **Tone** | **Unorthodox** oddballs — not orthodox young masters |
| **Young prodigy** | **#1** owns qi genius slot — **not** Gu Wei (pit separate) |
| **Dormancy** | Cold war — banner-building and proxy fights; **not** open gorge civil war |

**What winning gets (eventually):** Withdrawal seals, branch sleepers, pit feed schedule, pulpit deployment — **horror bureaucracy**, not godhood.

**What seven are not:** Clone vessels (usually), pit successors, sermon gods.

---

### Succession & banner war (owner lock 2026-08-30)
...
| Phase | What happens |
|-------|----------------|
| **Mo Xuan alive** | Collect chaff elders + train legions; court major elders quietly; **hide cards** |
| **Mo Xuan dies** | Cascade — chaff bandwagons, major elders commit, seal scramble |
| **Founder** | Indifferent to infighting unless pit feed / silence threatened — **strong rise, weak culled** |

Mo Xuan **allows** banner-building as training; **punishes** threats to withdrawal or gorge spine. Assassination is deniable, rare, and costly.

**Chaff elders** — small prestige each; menial access (ration logs, rotations, safe houses); cheap to court; disciples wary of showing hoard size. **Major elder** defection = everyone notices.

---

### Charm (distributed — not one "face" disciple)

Charm is a **tool**, different per disciple — not a single envoy archetype.

| # | Charm flavor |
|---|----------------|
| **1** Genius | Natural likability — merit darling, elders' hopeful (degree TBD) |
| **2** Fanatic | **Overbearing devotion** — effective on lower cult rungs; sacrament charisma |
| **3** Lazy refuser | **Devil-may-care** — attracts recruits who mistake apathy for freedom |
| **4** Schemer | **Most outwardly charming** — confident host; wine, debt, flattery |
| **5** Assassin | **Performed charm** — reads smooth, feels **fake** (not forced — he's good at the mask) |
| **6** Soul genius | Unsettling or absent — not the social lane |
| **7** Knife | Filial courtesy — **Mo Xuan's manners**; warmth as learned discipline |

---

### The seven (archetypes — names TBD)

| # | Archetype | Wants / posture | Banner & legion sketch |
|---|-----------|-----------------|------------------------|
...
| **7** | **Knife-engineer** | **Become Mo Xuan** — filial; arrays/formations to **earn** Patriarch | Array hermits, mouth wardens; few elite terrain fighters |

#### #4 schemer (owner refine)

**Not a coward** — **cautious** to the point of mockery ("coward" is rival propaganda). Confident and **most charming** in the room. Backs off **open** confrontation; wins through subterfuge, debt, and long campaigns. Will take the field when the math is already won.
...
**Needs a hidden difference** (defect TBD) — carbon copy surface, not identical soul. Open: trusts arrays over people? founder-loyal when Mo Xuan isn't? never learned when to stop?

Contrast **#3 refuser** — one won't sit; one **desperately wants** to inherit correctly.
...
1. Names + gender pass  
2. #7 hidden defect lock  
3. Light chaff-elder roster (5–8 names, mostly minor)  
4. One rumor line per disciple for gorge juniors  
5. Player entry — which disciple(s) surface first?

---

## Pit specimens (founder only)

Two existences **locked below** inner court. Rumors spread with **fear**; full truth is VR envoy tier and above.

| | **Pit One** | **Pit Two** |
|--|-------------|-------------|
| **Axis** | **Will** / dantian | **Intake** / flesh |
| **Breaks** | Intent before doctrine | Conversion in wrong organ (ward syllabus failed) |
| **Founder question** | Can hunger exist without Canon? | Can devouring bypass the dantian? |
| **vs seven** | Off merit board | Off merit board |
| **vs body ward** | N/A | Ward could not fix — see [`heavenly-demon-cult-body-ward.md`](heavenly-demon-cult-body-ward.md) |
...
- [x] Realm cap GC — locked (**Early GC**)
...
`data.js` factions; story `fate:` hooks; chronicle entries at NS+ rep; pit zone fiction only until hidden map ships.
