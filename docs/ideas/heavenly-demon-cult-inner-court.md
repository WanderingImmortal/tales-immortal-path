...
**Status:** `designed` (framework only — faces TBD except Pit One sibling context).
...
**What winning gets:** Withdrawal seals, branch sleepers, pit feed schedule, pulpit deployment — **horror bureaucracy**, not godhood.

**What seven are not:** Clone vessels (usually), pit successors, sermon gods.

### Tackle order (when drafting faces)

1. Lock seven **roles** (fixer, blade, ledger, envoy, array, coward, true believer) — names later  
2. One knows pulpit is clone; one wants mask anyway; one refuses chair  
3. Rumor lines for pit two leak through **one** of the seven (optional)
