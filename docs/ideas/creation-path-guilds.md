...
| **Forging** | **Branch in Longcheng**; HQ deferred (ore-adjacent city TBD) | Imperial licensing + commissions at capital; forges stay near veins — spine: [`forgers-guild.md`](forgers-guild.md) |
